...
namespace Support
{
	...
	namespace Exception
	{
		...
		{
			public:
				RootException(Exception&& original, Location&& location) : Exception{original}, Location{location} {}
		};
		...
		{
			public:
				WrapperException(Exception&& original, Location&& location) : Exception{original}, Location{location}, std::nested_exception{} {}
				WrapperException(Exception&& original, Location&& location, std::exception_ptr wrapped) : Exception{original}, Location{location}, std::nested_exception{wrapped} {}
		};
